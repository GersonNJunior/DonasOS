const App=(()=>{
  ...
  async function supabaseSalvarClienteOficial(c){
    try{
      ...
      // Alterações em clientes cadastrados serão feitas somente pelo ADM em fluxo próprio.
      if(tel){
        try{
